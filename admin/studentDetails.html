        ...
        <div class="row">
            <div class="col-lg-10 ms-auto p-4 overflow-auto">
                ...
                <div class="container mt-4">
                    <h2 class="text-start">Student List</h2>                   
                    ...
                    <?php
                        ...
                        if ($search_term) {
                            $query = "SELECT * FROM students WHERE `name` LIKE '%$search_term%' OR `email` LIKE '%$search_term%' OR `phone` LIKE '%$search_term%' OR `class` LIKE '%$search_term%' OR `city` LIKE '%$search_term%' ORDER BY student_id DESC LIMIT $offset, $records_per_page";
                        } else {
                            $query = "SELECT * FROM students ORDER BY created_at DESC LIMIT $offset, $records_per_page";
                        }

                        $students = mysqli_query($db, $query);

                        if ($search_term) {
                            $count_query = "SELECT COUNT(*) FROM students WHERE name LIKE '%$search_term%'";
                        } else {
                    ...
                    <form method="get" action="">
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" name="search" placeholder="Search by name, email, phone, class or city" value="<?php echo isset($_GET['search']) ? $_GET['search'] : ''; ?>">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="9" class="text-center text-danger fw-bold">
                                        <?php echo $search_term ? 'No students found for your search.' : 'No students found.'; ?>
                                    </td>
                                </tr>
                                <?php } ?>
                            </tbody>
