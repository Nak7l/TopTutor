<?php
    ...
    if (isset($_GET['id'])) {
        ...
        $query = "DELETE FROM studentMSG WHERE id = $id";
            ...
            <div class="border-0 mb-4">
                <div class="card-body">
                    ...
                    <div class="text-end mb-4 d-flex justify-content-between">
                        <h3 class="mb-0">Student's Queries</h3>
                        <?php 
                            // Check if there are any messages in the database
                            $q = "SELECT * FROM `studentMSG` ORDER BY `id` DESC";
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    if ($search_term) {
                                        $q = "SELECT * FROM `studentMSG` WHERE `name` LIKE '%$search_term%' OR `email` LIKE '%$search_term%' OR `message` LIKE '%$search_term%' ORDER BY `id` DESC";
                                    } else {
                                        $q = "SELECT * FROM `studentMSG` ORDER BY `id` DESC";
                                    }
            ...
            function confirmDelete(id) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = "studentMessages.php?id=" + id;
                    }
                });
            }
        </script>
        ...
        <script>
            function confirmDeleteAll() {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = "studentMessages.php?del=all";
                    }
                });
            }
        </script>
