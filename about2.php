...
<body class="bg">
    ...
    <section class="cta-section mb-md-4 mt-md-4" data-aos="zoom-in-up">
        <h2 data-aos="fade-right">Start Your Teaching Journey Today</h2>
        <p data-aos="fade-left">Find the perfect tutor and begin your education journey now!</p>
        <a href="search_student.php" class="btn btn-light btn-lg" data-aos="zoom-out-up">Find Your Student</a>
    </section>
